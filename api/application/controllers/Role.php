...
class Role extends REST_Controller 
{
    ...
    function list_get()
    {
        ...
        $rows   = $this->RoleModel->get_paged_list($crit, $sort, $order, $size, $offset)->result();
        $total  = $this->RoleModel->get_count($crit);
	...
	public function save_post() {
		...
		$values['id'] = $this->RoleModel->save($values);
