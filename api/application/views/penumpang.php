				...
				<table style="width: 100%; border: 1px solid;">
					<tr>
						...
						<th style="width: 20%; padding: 5px; background-color: #cccccc; text-align: center; border: 1px solid; padding: 5px;">NAMA</th>
						...
						<th style="width: 15%; padding: 5px; background-color: #cccccc; text-align: center; border: 1px solid; padding: 5px;">NO. PASPOR</th>
					</tr>
					...
					<tr>
						...
						<td style="text-align: center; border: 1px solid; padding: 5px;"><?php echo ($row->id_jenis_identitas == '3') ? $row->no_identitas : '-'; ?></td>
					</tr>
					<?php $no++; endforeach; ?>
				</table>
				<?php endif; ?>